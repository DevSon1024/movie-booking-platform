...
const AdminMoviesPage = () => {
  ...
  const [viewMode, setViewMode] = useState(
    localStorage.getItem("adminMoviesView") || "grid",
  );
  ...
  return (
    <div className="p-2 sm:p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="bg-gray-800 hover:bg-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600 text-white px-5 py-2.5 rounded-lg shadow-lg flex items-center font-semibold transition transform hover:scale-105"
          >
            <FaUserTie className="mr-2" /> Manage Celebrities
          </button>
          <button
            onClick={handleOpenAdd}
            className="bg-red-600 hover:bg-red-700 text-white px-6 py-2.5 rounded-lg shadow-lg flex items-center font-semibold transition transform hover:scale-105"
          >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div className="relative w-full md:max-w-md">
          <div className="absolute top-4 right-10 pointer-events-none z-10">
            <kbd className="hidden sm:inline-block bg-gray-100 dark:bg-gray-700 text-gray-400 text-xs px-2 py-0.5 rounded border border-gray-200 dark:border-gray-600 font-mono shadow-sm">
              Shift + /
            </kbd>
          </div>
          <MovieSearchDropdown
              ...
              <div className="p-4 flex flex-col flex-1">
                ...
                <div className="flex gap-2 mt-auto">
                  ...
                  <button
                    ...
                    className="flex-1 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 py-2 rounded-lg text-sm font-semibold hover:bg-red-100 dark:hover:bg-red-900/50 transition"
                  >
                    Delete
                  </button>
                </div>
      ...
      {isCelebrityModalOpen && (
        <ManageCelebrities onClose={() => setIsCelebrityModalOpen(false)} />
      )}
    </div>
  );
};
