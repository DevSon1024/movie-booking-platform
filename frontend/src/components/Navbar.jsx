    ...
    <nav className="bg-white/85 dark:bg-gray-900/85 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50 shadow-sm sticky top-0 z-50 transition-all duration-300">
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center h-20">
          <Link
            to="/"
            className="flex items-center space-x-2 text-2xl font-bold text-red-600 dark:text-red-500 shrink-0"
          >
            <FaTicketAlt />
          ...
          <div className="hidden md:flex items-center space-x-6 shrink-0">
            <Link
              to="/"
              className="text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 font-medium transition text-base"
            >
              Movies
            </Link>
            ...
            {userInfo ? (
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <span className="font-semibold text-base max-w-[100px] truncate">
                    {userInfo.name}
                  </span>
                </button>
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-3 w-64 bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden animate-fade-in origin-top-right z-50">
                    ...
                    <div className="py-2">
                      ...
                      <Link
                        to="/profile"
                        className="flex items-center px-5 py-3 text-base text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
                        onClick={() => setIsProfileOpen(false)}
                      >
                        <FaUserCircle className="mr-3 text-gray-400" /> My
                        Profile
                      </Link>
                      ...
                      <Link
                        ...
                        onClick={() => setIsProfileOpen(false)}
                      >
                        <FaTicketAlt className="mr-3 text-gray-400" /> My
                        Bookings
                      </Link>
                      ...
                      <Link
                        to="/payment-options"
                        className="w-full flex items-center px-5 py-3 text-base text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
                        onClick={() => setIsProfileOpen(false)}
                      >
                        <FaCreditCard className="mr-3 text-gray-400" /> Payment
                        Options
                      </Link>
                    </div>
              ...
              <div className="flex items-center space-x-3">
                <Link
                  to="/login"
                  className="px-4 py-2 text-base text-gray-700 dark:text-gray-200 hover:text-red-600 dark:hover:text-red-400 transition"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="px-6 py-2 text-base bg-red-600 hover:bg-red-700 text-white rounded-full font-bold transition shadow-md hover:shadow-lg"
                >
                  Sign Up
                </Link>
              </div>
        ...
        <div className="md:hidden bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-t border-gray-200/50 dark:border-gray-800/50 absolute w-full left-0 shadow-2xl animate-slide-down z-40">
          <div className="flex flex-col p-4 space-y-2">
            <Link
              ...
              className="block px-4 py-3 rounded-lg text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 text-base font-medium"
            >
              🎬 Movies
            </Link>
            ...
            {userInfo ? (
              <>
                ...
                <Link
                  to="/profile"
                  onClick={() => setIsMobileOpen(false)}
                  className="flex items-center px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 text-base"
                >
                ...
                <Link
                  to="/my-reviews"
                  onClick={() => setIsMobileOpen(false)}
                  className="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 text-base"
                >
                ...
                {userInfo.role === "admin" && (
                  <Link
                    to="/admin"
                    onClick={() => setIsMobileOpen(false)}
                    className="flex items-center px-4 py-3 rounded-lg text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/10 mt-2 text-base"
                  >
                    <FaUserCog className="mr-3" /> Admin Panel
                  </Link>
                )}
                ...
                <button
                  onClick={handleLogout}
                  className="flex items-center w-full px-4 py-3 mt-2 rounded-lg text-red-600 hover:bg-red-50 dark:hover:bg-gray-800 text-base"
                >
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <Link
                  to="/login"
                  onClick={() => setIsMobileOpen(false)}
                  className="px-4 py-3 text-center text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg text-base"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  onClick={() => setIsMobileOpen(false)}
                  className="px-4 py-3 text-center bg-red-600 text-white rounded-lg font-bold text-base"
                >
                  Sign Up
                </Link>
              </div>
